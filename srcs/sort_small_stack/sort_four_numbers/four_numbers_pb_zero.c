...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/17 14:33:38 by oozsertt          #+#    #+#             */
/*   Updated: 2021/12/17 17:50:13 by oozsertt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static t_nbr_data	*zero_is_first(t_nbr_data *stack_a, t_nbr_data **stack_b)
{
...
t_nbr_data	*zero_is_third(t_nbr_data *stack_a, t_nbr_data **stack_b)
{
	stack_a = ra(stack_a);
	stack_a = ra(stack_a);
	if (is_lst_sorted(stack_a) == TRUE)
...
t_nbr_data	*zero_is_last(t_nbr_data *stack_a, t_nbr_data **stack_b)
{
	stack_a = rra(stack_a);
	if (is_lst_sorted(stack_a) == TRUE)
		return (stack_a);
